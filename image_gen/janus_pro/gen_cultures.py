...
folder = '../unesco_cultures_generated/janus_pro'
...
for data in tqdm(cultures):
    ...
    conversation = [
        {
            "role": "<|User|>",
            "content": prompt.format(data['culture_name']).replace('/', ' or '),
        },
    ...
    generate(
        ...
        vl_chat_processor,
        prompt,
        f'{folder}/[{data["country"]}] {prompt.format(data["culture_name"]).replace("/", " or ")}.png'
    )
